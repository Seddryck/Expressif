...
Follow the [argument-context documentation guidelines](../../../AGENTS.md#argument-context-documentation) when describing parameter evaluation, including the source of contextual references.
