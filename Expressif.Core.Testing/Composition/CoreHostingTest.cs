...
public sealed class CoreHostingTest
{
    ...
    [Test]
    public void CoreAssemblyDoesNotReferenceOfficialLibraryAssembly()
        => Assert.That(
            typeof(IExpression).Assembly.GetReferencedAssemblies()
                .Any(assembly => assembly.Name == "Expressif.Library"),
            Is.False);
