...
public class ExpressionFactoryTest
{
    ...
    public void Create_WithConfiguredComponents_UsesParserThenBinder()
    {
        ...
        var factory = new Expressif.ExpressionFactory(binder, parser);
    ...
    [Test]
    public void Create_WithCustomParserAndBinder_UsesBoth()
    {
        var parser = new TrackingParser();
        var factory = new Expressif.ExpressionFactory(new ExpressionBinder(), parser);
        var expression = factory.Create("ignored");
