...
public class ParameterSerializerTest
{
    ...
    {
        var parameter = ExpressifBinderFactory.Create().BindParameter(ExpressionParser.Parse(source));
    ...
    public void Serialize_OrderingLiteral_RoundTripsCanonicalSingleton(OrderingValue value)
    {
        ...
        var parsed = ExpressifBinderFactory.Create().BindParameter(ExpressionParser.Parse(serialized));
    ...
    public void Serialize_AllDimensionLiteral_RoundTripsSingleton()
    {
        ...
        var parsed = ExpressifBinderFactory.Create().BindParameter(ExpressifSyntax.Parse(serialized));
    ...
    {
        var parameter = ExpressifBinderFactory.Create().BindParameter(ExpressifSyntax.Parse(source));
    ...
    {
        var parameter = ExpressifBinderFactory.Create().BindParameter(ExpressifSyntax.Parse("T(1, ...T(2, 3), ...)"));
