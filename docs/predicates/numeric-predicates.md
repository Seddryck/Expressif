...
has_children: true
has_toc: false
permalink: /predicates/numeric-predicates/
tags:
  - predicates
  - numeric
...
| [`is-negative-or-zero`]({{ '/predicates/numeric/is-negative-or-zero/' | relative_url }}) | Returns true if the numeric argument is less or equal to 0. |
| [`is-odd`]({{ '/predicates/numeric/arithmetic/is-odd/' | relative_url }}) | Returns `true` if the numeric value passed as argument is odd. Returns `false` otherwise. |
| [`is-one`]({{ '/predicates/numeric/is-one/' | relative_url }}) | Returns true if the numeric argument is equal to 1. |
