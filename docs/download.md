---
title: Download Expressif
subtitle: Choose what you want to use and get the right package without decoding release filenames.
nav_order: 2
permalink: /download/
...
<div id="download-app" class="download-app" data-repository="Seddryck/Expressif" data-windows-installer-url="{{ '/cli/windows-installer/' | relative_url }}">
  ...
  <div class="download-loading" role="status">Loading available Expressif releases…</div>
</div>

<script src="{{ '/assets/js/download.js' | relative_url }}" defer></script>
