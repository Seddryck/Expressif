...
| `result` | `expression` | No | Specifies the expression that produces the value appended for the current seed. Omission is preserved for operator-specific handling. |
