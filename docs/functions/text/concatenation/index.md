...
| Name | Overview |
|:-----|:---------|
| [`append`]({{ '/functions/text/concatenation/append/' | relative_url }}) | Returns the argument value followed by the parameter value. If the argument is `null`, it returns the text specified as the parameter. |
...
| [`prepend`]({{ '/functions/text/concatenation/prepend/' | relative_url }}) | Returns the argument value preceeded by the parameter value. If the argument is `null`, it returns the text specified as the parameter. |
