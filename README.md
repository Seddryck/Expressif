...
|Temporal | within-following-month         | dateTime-is-within-following-month    |
|Temporal | within-following-week          | dateTime-is-within-following-week     |
|Temporal | within-following-year          | dateTime-is-within-following-year     |
|Temporal | within-next-days               | dateTime-is-within-next-days          |
|Temporal | within-preceding-month         | dateTime-is-within-preceding-month    |
|Temporal | within-preceding-week          | dateTime-is-within-preceding-week     |
|Temporal | within-preceding-year          | dateTime-is-within-preceding-year     |
