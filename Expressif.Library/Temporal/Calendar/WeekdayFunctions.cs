...
{
    public Func<Expressif.Values.Weekday> DayOfWeek { get; }

    /// <param name="weekday">The day of week to compare to the argument.</param>
    public NextWeekday(Func<Expressif.Values.Weekday> weekday)
...
public class NextWeekdayOrSame : BaseTemporalWeekdayFunction
{
    ...
    /// <param name="weekday">The day of week to compare to the argument.</param>
    public NextWeekdayOrSame(Func<Expressif.Values.Weekday> weekday)
        : base() { DayOfWeek = weekday; }
...
public class PreviousWeekday : BaseTemporalWeekdayFunction
{
    ...
    /// <param name="weekday">The day of week to compare to the argument.</param>
    public PreviousWeekday(Func<Expressif.Values.Weekday> weekday)
        : base() { DayOfWeek = weekday; }
...
public class PreviousWeekdayOrSame : BaseTemporalWeekdayFunction
{
    ...
    /// <param name="weekday">The day of week to compare to the argument.</param>
    public PreviousWeekdayOrSame(Func<Expressif.Values.Weekday> weekday)
        : base() { DayOfWeek = weekday; }
...
{
    /// <param name="weekday">The day of week to compare to the argument.</param>
    public FirstInMonth(Func<Expressif.Values.Weekday> weekday)
        : base(weekday) { }
...
{
    /// <param name="weekday">The day of week to compare to the argument.</param>
    public LastInMonth(Func<Expressif.Values.Weekday> weekday)
        : base(weekday) { }
...
public class NextBusinessDays : BaseTemporalWeekdayFunction
{
    ...
    public NextBusinessDays(Func<int> count)
        : base() => (Count, IsBusinessDay) = (count, new Expressif.Library.Temporal.BusinessDay().Evaluate);
