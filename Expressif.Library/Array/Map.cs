...
public class Map : BaseArrayFunction
{
    ...
    public Map([ArgumentRole(ArgumentRole.Transformation)] [AcceptedExpressionShape(AcceptedExpressionShape.OpenExpression)] [ProviderLifetime(ProviderLifetime.FreshPerRequest)] Func<IFunction> transformation)
