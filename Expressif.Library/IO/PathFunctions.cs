...
public abstract class BasePathFunction : BaseTextFunction, IBasePathFunction
{
    ...
    protected override object EvaluateEmpty() => Expressif.Values.Special.Empty.Instance.Keyword;
    protected override object EvaluateBlank() => Expressif.Values.Special.Empty.Instance.Keyword;
    protected override object EvaluateSpecial(string value) => Expressif.Values.Special.Empty.Instance.Keyword;
}
