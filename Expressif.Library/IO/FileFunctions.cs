...
public abstract class BaseFileFunction<TOut> : BaseTextFunction<TOut>, IBasePathFunction
{
    ...
    protected override object EvaluateNull() => throw new InvalidIOException(Expressif.Values.Special.Null.Keyword);
    protected override object EvaluateEmpty() => throw new InvalidIOException(Expressif.Values.Special.Empty.Keyword);
    protected override object EvaluateBlank() => throw new InvalidIOException(Whitespace.Keyword);
