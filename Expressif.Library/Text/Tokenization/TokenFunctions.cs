...
public class Token : BaseTextFunction
{
    ...
    protected override object EvaluateBlank() => Separator == null || char.IsWhiteSpace(Separator.Invoke()) ? Expressif.Values.Special.Null.Instance.Keyword : Whitespace.Instance.Keyword;
