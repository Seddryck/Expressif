...
/// <summary>Groups array elements by their one-based dense rank using typed criteria.</summary>
[Function(prefix: "")]
[Scope("sorting")]
public sealed class DenseRankBy : IFunction<IEnumerable, Values.Grouping>
{
    ...
    public DenseRankBy(IEnumerable<SortByCriterion> criteria)
    {
    ...
    public Values.Grouping Evaluate(IEnumerable value)
        => new DenseRank().Evaluate(SortBy.BuildTable(value, criteria));
