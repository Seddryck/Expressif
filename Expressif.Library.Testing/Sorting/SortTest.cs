...
public class SortTest
{
    ...
    {
        var result = TestExpression.Create("array((sort-key(sort-term(1, compare-numeric~)) => \"first\"), (sort-key(sort-term(1, compare-numeric~)) => \"second\")) | sort-table | sort").Evaluate(null);
    ...
    {
        var result = TestExpression.Create("array((sort-key(sort-term(\"bad\", compare-numeric~)) => 1), (sort-key(sort-term(2, compare-numeric~)) => 2)) | sort-table | sort");
