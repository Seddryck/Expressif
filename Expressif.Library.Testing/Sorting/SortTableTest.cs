...
public class SortTableTest
{
    ...
    {
        var table = (SortTableValue)TestExpression.Create("array((sort-key(sort-term(2, compare-numeric~)) => \"b\"), (sort-key(sort-term(1, compare-numeric~)) => \"a\")) | sort-table").Evaluate(null)!;
